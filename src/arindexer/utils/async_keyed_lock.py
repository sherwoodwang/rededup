...
This module provides AsyncKeyedLock, a data structure that allows multiple async tasks
...
class AsyncKeyedLock:
    ...
    AsyncKeyedLock manages per-key locks that allow multiple concurrent tasks to
    ...
    class _Lock:
        ...
        Args:
            parent: The parent AsyncKeyedLock instance
            key: The hashable key identifying the resource to lock
        """

        def __init__(self, parent, key):
            self._parent: AsyncKeyedLock = parent
            self._key = key
    ...
    def __init__(self):
        """Initialize a new empty AsyncKeyedLock.
    ...
    def lock(self, key):
        ...
        """
        return AsyncKeyedLock._Lock(self, key)